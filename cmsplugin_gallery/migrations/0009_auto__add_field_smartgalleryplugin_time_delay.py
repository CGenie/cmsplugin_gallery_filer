...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SmartGalleryPlugin.time_delay'
        db.add_column(u'cmsplugin_smartgalleryplugin', 'time_delay',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=5000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SmartGalleryPlugin.time_delay'
        db.delete_column(u'cmsplugin_smartgalleryplugin', 'time_delay')
