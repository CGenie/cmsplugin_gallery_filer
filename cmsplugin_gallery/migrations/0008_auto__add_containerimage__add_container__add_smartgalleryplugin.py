...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cmsplugin_gallery_containerimage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('inline_ordering_position', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('container', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cmsplugin_gallery.Container'])),
            ('src', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Image'], null=True, blank=True)),
        ...
        db.send_create_signal(u'cmsplugin_gallery', ['ContainerImage'])

        # Adding model 'Container'
        db.create_table(u'cmsplugin_gallery_container', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('inline_ordering_position', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('gallery', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cmsplugin_gallery.SmartGalleryPlugin'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'cmsplugin_gallery', ['Container'])

        # Adding model 'SmartGalleryPlugin'
        db.create_table(u'cmsplugin_smartgalleryplugin', (
        ...
        db.send_create_signal(u'cmsplugin_gallery', ['SmartGalleryPlugin'])


    def backwards(self, orm):
        # Deleting model 'ContainerImage'
        db.delete_table(u'cmsplugin_gallery_containerimage')

        # Deleting model 'Container'
        db.delete_table(u'cmsplugin_gallery_container')

        # Deleting model 'SmartGalleryPlugin'
        db.delete_table(u'cmsplugin_smartgalleryplugin')
